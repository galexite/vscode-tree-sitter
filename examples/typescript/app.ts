...
const f1 = function (i: number): number {
  return i * i;
};
// Return type inferred
const f2 = function (i: number) {
  return i * i;
};
// "Fat arrow" syntax
...
const p: Person = { name: "Bobby", move: () => {} };
// Objects that have the optional property:
const validPerson: Person = { name: "Bobby", age: 42, move: () => {} };
// Is not a person because age is not a number
const invalidPerson: Person = { name: "Bobby", age: true };
...
const s1 = new Geometry.Square(5);

// Local alias for referencing a module
import G = Geometry;

const s2 = new G.Square(10);
...
const tuple = pairToTuple({ item1: "hello", item2: "world" });
...
const p3: Person = p2; // Ok, read-only alias for p2
...
const moreNumbers: ReadonlyArray<number> = numbers;
...
const arrayOfAnyType = [1, "string", false];
